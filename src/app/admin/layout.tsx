...
const nav = [["/admin", "Dashboard"], ["/admin/orders", "Orders (OMS)"], ["/admin/products", "Catalogue (CMS)"], ["/admin/vendors", "Vendors"], ["/admin/preorders", "Pre-orders"], ["/admin/returns", "Returns & Refunds"], ["/admin/messages", "Messages"]];
